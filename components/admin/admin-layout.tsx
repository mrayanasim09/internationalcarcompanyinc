...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Car Management", href: "/admin/dashboard", icon: CarIcon },
  ]
          ...
          <div className="flex items-center justify-between p-4 border-b border-border">
            <div className="flex items-center space-x-2">
              ...
              <div className="relative w-12 h-8">
                <Image src="/International Car Company Inc. Logo.png" alt="International Car Company Inc Logo" fill className="object-contain" priority sizes="48px" />
              </div>
          ...
          <div className="flex items-center px-6 py-4 border-b border-border">
            <div className="flex items-center gap-3">
              ...
              <div className="relative w-10 h-8">
                <Image src="/International Car Company Inc. Logo.png" alt="International Car Company Inc Logo" fill className="object-contain" priority sizes="40px" />
              </div>
              <div>
